...
from app.api.task_views import (
    task_list_create, task_detail, complete_task, archive_task,
    create_feedback, list_feedback,
)
from app.api.analytics_views import analytics_dashboard, tasks_over_time, productivity_score
from app.api.admin_views import admin_users, admin_tasks, admin_analytics, admin_update_user
...
urlpatterns = [
    ...
    # Feedback — POST create, GET list
    path('feedback/', create_feedback, name='feedback-create'),
    path('feedback/list/', list_feedback, name='feedback-list'),
    ...
    path('admin/users/<uuid:user_id>/', admin_update_user, name='admin-update-user'),
